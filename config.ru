...
<section class='container'>
          <hgroup>
            <h1>Welcome to cmartin Ruby application on OpenShift</h1>
          </hgroup>
          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code changes</h2>
                <p>
                  El codigo fuente se encuentra en <a href="https://github.com/claudiapmartin/ruby-ex">Claudia Martin GitHub repository</a>.
                </p>
          </section>
        </div>
